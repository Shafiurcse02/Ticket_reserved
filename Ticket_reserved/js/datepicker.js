...
// Defaults should the locale file not load
    ...
    function datePicker(options) {
        ...
        o.setRangeLow = function(range) {
            if (String(range).search(/^(\d\d?\d\d)(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])$/) == -1)
                range = '';
        ...
        o.setEnabledDates = function(dateArray) {
            var fin = [];
            for (var i = dateArray.length; i--; ) {
                if (dateArray[i].match(/^(\d\d\d\d|\*\*\*\*)(0[1-9]|1[012]|\*\*)(0[1-9]|[12][0-9]|3[01]|\*\*)$/) != -1 && dateArray[i] != "********")
                    fin[fin.length] = dateArray[i];
            }
            ;
            if (fin.length) {
        ...
        o.setFirstDayOfWeek = function(e) {
            ...
            if (elem.tagName.toLowerCase() != "th") {
                while (elem.tagName.toLowerCase() != "th")
        ...
        o.createButton = function() {
            ...
            but = null;
                ...
                o.create = function() {
                    ...
                    createThAndButton(tr, [{className: "prev-but", id: "-prev-year-but", text: "\u00AB", title: datePicker.titles[2], onmousedown: function(e) {
                                ...
                                o.events.incDec(e, 0, 0, 1);
                            }, onmouseout: o.events.clearTimer}, {className: "next-but", id: "-next-year-but", text: "\u00BB", title: datePicker.titles[3], onmousedown: function(e) {
                                o.events.incDec(e, 0, 1, 0);
        ...
        o.updateTable = function(noCallback) {
            ...
            if (!noCallback && "onupdate" in datePickerController && typeof (datePickerController.onupdate) == "function")
        ...
        o.show = function() {
            var elem = o.getElem();
            if (!elem || o.visible || elem.disabled)
                return;
